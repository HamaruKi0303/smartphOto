...
class Sample(SmartphOto.SmartphOto):
    ...
    def main_Sequential(self):
        ...
        while 1:
            ...
            # self.tap_temp_image5_Sequential(r"image\azuren\SP2.jpg", th=0.8)
            # self.tap_temp_image5_Sequential(r"image\azuren\sortie2.jpg", th=0.8)
            # self.tap_temp_image5_Sequential(r"image\azuren\sortie3.jpg", th=0.8)
